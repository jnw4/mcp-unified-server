...
export declare const UserEventJobPayload2687Provider: {
    readonly Gitlab: "gitlab";
};
export type UserEventJobPayload2687Provider = ClosedEnum<typeof UserEventJobPayload2687Provider>;
export type Job7 = {
...
export declare const UserEventJobPayload2686Provider: {
    readonly Gitlab: "gitlab";
};
export type UserEventJobPayload2686Provider = ClosedEnum<typeof UserEventJobPayload2686Provider>;
export type Job6 = {
    type: "gitlab-push";
...
export declare const UserEventJobPayload2685Provider: {
    readonly Github: "github";
    readonly GithubLimited: "github-limited";
    readonly GithubCustomHost: "github-custom-host";
};
export type UserEventJobPayload2685Provider = ClosedEnum<typeof UserEventJobPayload2685Provider>;
export type Job5 = {
    createdAt?: number | undefined;
    eventful?: boolean | undefined;
    /**
...
export declare const UserEventJobPayload268Provider: {
    readonly Github: "github";
    readonly GithubLimited: "github-limited";
    readonly GithubCustomHost: "github-custom-host";
};
export type UserEventJobPayload268Provider = ClosedEnum<typeof UserEventJobPayload268Provider>;
export type Job4 = {
...
export declare const UserEventPayload261Role: {
    readonly Admin: "ADMIN";
    readonly ProjectDeveloper: "PROJECT_DEVELOPER";
    readonly ProjectViewer: "PROJECT_VIEWER";
    readonly ProjectGuest: "PROJECT_GUEST";
};
export type UserEventPayload261Role = ClosedEnum<typeof UserEventPayload261Role>;
...
export declare const UserEventPayload256ToAccountType: {
    readonly Team: "team";
    readonly User: "user";
};
export type UserEventPayload256ToAccountType = ClosedEnum<typeof UserEventPayload256ToAccountType>;
...
export declare const UserEventPayload236Type: {
    readonly List: "list";
};
export type UserEventPayload236Type = ClosedEnum<typeof UserEventPayload236Type>;
export declare const UserEventPayload236BeforeType: {
    readonly String: "string";
};
export type UserEventPayload236BeforeType = ClosedEnum<typeof UserEventPayload236BeforeType>;
...
export declare const UserEventPayload236AfterType: {
    readonly List: "list";
};
export type UserEventPayload236AfterType = ClosedEnum<typeof UserEventPayload236AfterType>;
export declare const UserEventPayload236AfterResourcesType: {
    readonly String: "string";
};
export type UserEventPayload236AfterResourcesType = ClosedEnum<typeof UserEventPayload236AfterResourcesType>;
...
export declare const UserEventPayload236Permissions: {
    readonly ReadDomain: "read:domain";
    readonly ReadWriteDomain: "read-write:domain";
    readonly ReadTeam: "read:team";
    readonly ReadBilling: "read:billing";
...
export type UserEventPayload236Permissions = ClosedEnum<typeof UserEventPayload236Permissions>;
export type After = {
...
export declare const UserEventPayload235Type: {
    readonly List: "list";
};
export type UserEventPayload235Type = ClosedEnum<typeof UserEventPayload235Type>;
export declare const UserEventPayload235ResourcesType: {
    readonly String: "string";
};
export type UserEventPayload235ResourcesType = ClosedEnum<typeof UserEventPayload235ResourcesType>;
export type Items = {
...
export declare const UserEventPayload223Action: {
    readonly Enable: "enable";
    readonly Disable: "disable";
};
export type UserEventPayload223Action = ClosedEnum<typeof UserEventPayload223Action>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload216Role: {
    readonly Admin: "ADMIN";
    readonly ProjectDeveloper: "PROJECT_DEVELOPER";
    readonly ProjectViewer: "PROJECT_VIEWER";
    readonly ProjectGuest: "PROJECT_GUEST";
};
export type UserEventPayload216Role = ClosedEnum<typeof UserEventPayload216Role>;
...
export declare const UserEventPayload215Role: {
    readonly Admin: "ADMIN";
    readonly ProjectDeveloper: "PROJECT_DEVELOPER";
    readonly ProjectViewer: "PROJECT_VIEWER";
    readonly ProjectGuest: "PROJECT_GUEST";
};
export type UserEventPayload215Role = ClosedEnum<typeof UserEventPayload215Role>;
...
export declare const UserEventPayload214Role: {
    readonly Admin: "ADMIN";
    readonly ProjectDeveloper: "PROJECT_DEVELOPER";
    readonly ProjectViewer: "PROJECT_VIEWER";
    readonly ProjectGuest: "PROJECT_GUEST";
};
export type UserEventPayload214Role = ClosedEnum<typeof UserEventPayload214Role>;
...
export declare const UserEventPayload213Role: {
    readonly Admin: "ADMIN";
    readonly ProjectDeveloper: "PROJECT_DEVELOPER";
    readonly ProjectViewer: "PROJECT_VIEWER";
    readonly ProjectGuest: "PROJECT_GUEST";
};
export type UserEventPayload213Role = ClosedEnum<typeof UserEventPayload213Role>;
...
export declare const UserEventPayload204Action: {
    readonly Mutate: "mutate";
};
export type UserEventPayload204Action = ClosedEnum<typeof UserEventPayload204Action>;
/**
 * The payload of the event, if requested.
 */
...
export declare const UserEventPayload203Action: {
    readonly ResumePlan: "resume_plan";
};
export type UserEventPayload203Action = ClosedEnum<typeof UserEventPayload203Action>;
...
export declare const UserEventPayload202Action: {
    readonly CancelPlan: "cancel_plan";
};
export type UserEventPayload202Action = ClosedEnum<typeof UserEventPayload202Action>;
 ...
 */
export declare const UserEventPayload135Type: {
 ...
 * The type of matching to perform
 */
export type UserEventPayload135Type = ClosedEnum<typeof UserEventPayload135Type>;
 ...
 * The type of matching to perform
 */
export declare const UserEventPayload135NextType: {
    readonly EndsWith: "endsWith";
    readonly StartsWith: "startsWith";
    readonly Equals: "equals";
};
 ...
 * The type of matching to perform
 */
export type UserEventPayload135NextType = ClosedEnum<typeof UserEventPayload135NextType>;
...
export declare const UserEventPayload85Configuration: {
    readonly SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE";
    readonly WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE";
};
export type UserEventPayload85Configuration = ClosedEnum<typeof UserEventPayload85Configuration>;
...
export declare const UserEventPayload85Role: {
    readonly Owner: "OWNER";
    readonly Member: "MEMBER";
    readonly Developer: "DEVELOPER";
    readonly Security: "SECURITY";
...
export declare const UserEventPayload85Type: {
    readonly User: "user";
};
...
export declare const UserEventPayload85BlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85BlockReason = ClosedEnum<typeof UserEventPayload85BlockReason>;
...
export declare const UserEventPayload85NewOwnerBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerBlockReason>;
...
export declare const UserEventPayload85NewOwnerFeatureBlocksBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerFeatureBlocksBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerFeatureBlocksBlockReason>;
...
export declare const UserEventPayload85NewOwnerFeatureBlocksBlobBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerFeatureBlocksBlobBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerFeatureBlocksBlobBlockReason>;
...
export declare const UserEventPayload85NewOwnerFeatureBlocksPostgresBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerFeatureBlocksPostgresBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerFeatureBlocksPostgresBlockReason>;
...
export declare const UserEventPayload85NewOwnerFeatureBlocksRedisBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerFeatureBlocksRedisBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerFeatureBlocksRedisBlockReason>;
...
export declare const UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason>;
export type MicrofrontendsRequest = {
    updatedAt: number;
    blockedFrom?: number | undefined;
    blockedUntil?: number | undefined;
    blockReason: UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason;
};
export declare const UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason>;
export type WorkflowStorage = {
    updatedAt: number;
    blockedFrom?: number | undefined;
    blockedUntil?: number | undefined;
    blockReason: UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason;
};
export declare const UserEventPayload85NewOwnerFeatureBlocksWorkflowStepBlockReason: {
    readonly AdminOverride: "admin_override";
    readonly LimitsExceeded: "limits_exceeded";
};
export type UserEventPayload85NewOwnerFeatureBlocksWorkflowStepBlockReason = ClosedEnum<typeof UserEventPayload85NewOwnerFeatureBlocksWorkflowStepBlockReason>;
 ...
 */
export declare const UserEventPayload85NewOwnerAction: {
    readonly Enabled: "enabled";
    readonly Disabled: "disabled";
};
/**
 * The action that occurred
 */
export type UserEventPayload85NewOwnerAction = ClosedEnum<typeof UserEventPayload85NewOwnerAction>;
/**
...
export declare const UserEventPayload82Action: {
    readonly Log: "log";
    readonly Challenge: "challenge";
    readonly Deny: "deny";
};
export type UserEventPayload82Action = ClosedEnum<typeof UserEventPayload82Action>;
...
export declare const UserEventPayload81Action: {
    readonly Log: "log";
    readonly Challenge: "challenge";
    readonly Deny: "deny";
};
export type UserEventPayload81Action = ClosedEnum<typeof UserEventPayload81Action>;
/**
 * The payload of the event, if requested.
 */
 ...
 */
export declare const UserEventPayload76OldEnvVarType: {
    readonly System: "system";
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload76OldEnvVarType = ClosedEnum<typeof UserEventPayload76OldEnvVarType>;
/**
 ...
 * environments this env variable targets
 */
export declare const UserEventPayload76Target: {
    readonly Production: "production";
    readonly Preview: "preview";
    readonly Development: "development";
};
 ...
 * environments this env variable targets
 */
export type UserEventPayload76Target = ClosedEnum<typeof UserEventPayload76Target>;
...
export type Payload = TwoHundredAndFiftySeven | EightySeven | NinetyOne | NinetySix | NinetyEight | OneHundredAndThirtyFive | FiftySix | FiftySeven | SixtyNine | SeventyTwo | SeventyEight | EightyFive | EightyEight | EightyNine | OneHundredAndNine | TwoHundredAndNine | TwoHundredAndFiftyNine | TwoHundredAndSeventy | Payload2 | FiftyOne | SixtyOne | Ninety | NinetySeven | OneHundredAndTwentyFour | OneHundredAndTwentyNine | OneHundredAndThirty | OneHundredAndThirtyThree | OneHundredAndThirtySix | OneHundredAndFortyOne | OneHundredAndFortyTwo | OneHundredAndFortyThree | OneHundredAndFortyFour | OneHundredAndFortyFive | OneHundredAndFortySix | OneHundredAndFortySeven | OneHundredAndFortyEight | OneHundredAndFortyNine | OneHundredAndSixtySeven | OneHundredAndNinetyEight | OneHundredAndNinetyNine | TwoHundredAndTwentyOne | TwoHundredAndFortySix | TwoHundredAndFiftyEight | TwoHundredAndSixtyTwo | TwoHundredAndSixtySeven | Sixteen | Twenty | TwentyFour | TwentyEight | Forty | FortyOne | FortyTwo | FortyThree | FiftyFive | SixtyFour | SixtyFive | SixtySix | Seventy | SeventyNine | Eighty | EightyOne | EightyTwo | EightyFour | OneHundred | OneHundredAndFour | OneHundredAndSeven | OneHundredAndEight | OneHundredAndTen | OneHundredAndEleven | OneHundredAndTwelve | OneHundredAndThirteen | OneHundredAndFourteen | OneHundredAndFifteen | OneHundredAndTwenty | OneHundredAndTwentySix | OneHundredAndTwentyEight | OneHundredAndThirtyOne | OneHundredAndThirtyTwo | OneHundredAndThirtyFour | OneHundredAndThirtySeven | OneHundredAndThirtyEight | OneHundredAndThirtyNine | OneHundredAndFifty | OneHundredAndFiftyOne | OneHundredAndFiftyTwo | OneHundredAndFiftyThree | OneHundredAndFiftyFour | OneHundredAndFiftyEight | OneHundredAndSeventySix | TwoHundredAndEleven | TwoHundredAndTwelve | TwoHundredAndEighteen | TwoHundredAndNineteen | TwoHundredAndTwenty | TwoHundredAndTwentyTwo | TwoHundredAndTwentyFour | TwoHundredAndTwentySeven | TwoHundredAndThirtyEight | TwoHundredAndThirtyNine | TwoHundredAndForty | TwoHundredAndFortyNine | TwoHundredAndFifty | TwoHundredAndFiftyOne | TwoHundredAndFiftyTwo | TwoHundredAndFiftyThree | TwoHundredAndFiftySix | TwoHundredAndSixty | TwoHundredAndSixtyFour | TwoHundredAndSixtyNine | Three | Four | Six | Seven | Eight | TwentyOne | TwentyTwo | TwentyFive | Thirty | ThirtySix | ThirtyEight | FortyFive | FortySix | FortySeven | FortyEight | FortyNine | Fifty | FiftyTwo | FiftyNine | Sixty | SixtyThree | SeventyThree | SeventySeven | EightyThree | EightySix | OneHundredAndThree | OneHundredAndSixteen | OneHundredAndSeventeen | OneHundredAndEighteen | OneHundredAndNineteen | OneHundredAndTwentyOne | OneHundredAndTwentyTwo | OneHundredAndTwentyFive | OneHundredAndFiftyFive | OneHundredAndFiftySix | OneHundredAndFiftySeven | OneHundredAndFiftyNine | OneHundredAndSixty | OneHundredAndSixtyThree | OneHundredAndSixtyFour | OneHundredAndSixtyFive | OneHundredAndSeventyTwo | OneHundredAndSeventySeven | OneHundredAndEightyTwo | OneHundredAndEightyThree | OneHundredAndEightyEight | OneHundredAndEightyNine | OneHundredAndNinetyOne | OneHundredAndNinetyTwo | TwoHundredAndTwo | TwoHundredAndThree | TwoHundredAndFour | TwoHundredAndTen | TwoHundredAndThirteen | TwoHundredAndFourteen | TwoHundredAndFifteen | TwoHundredAndSeventeen | TwoHundredAndTwentyFive | TwoHundredAndTwentySix | TwoHundredAndTwentyEight | TwoHundredAndThirty | TwoHundredAndThirtyOne | TwoHundredAndThirtyTwo | TwoHundredAndFortyOne | TwoHundredAndFortyThree | TwoHundredAndFortyFive | TwoHundredAndFiftyFour | TwoHundredAndFiftyFive | TwoHundredAndSixtyOne | Five | Nine | Ten | Nineteen | TwentySix | TwentyNine | ThirtyOne | ThirtyFive | ThirtySeven | ThirtyNine | FortyFour | FiftyThree | FiftyFour | FiftyEight | SixtyTwo | SixtySeven | SixtyEight | SeventyOne | NinetyTwo | NinetyThree | NinetyNine | OneHundredAndOne | OneHundredAndTwo | OneHundredAndFive | OneHundredAndSix | OneHundredAndTwentyThree | OneHundredAndTwentySeven | OneHundredAndSixtyOne | OneHundredAndSixtyTwo | OneHundredAndSixtySix | OneHundredAndSixtyEight | OneHundredAndSixtyNine | OneHundredAndSeventy | OneHundredAndSeventyThree | OneHundredAndSeventyFour | OneHundredAndSeventyFive | OneHundredAndEighty | OneHundredAndEightyOne | OneHundredAndEightyFour | OneHundredAndNinety | OneHundredAndNinetyThree | OneHundredAndNinetyFour | TwoHundred | TwoHundredAndOne | TwoHundredAndFive | TwoHundredAndSix | TwoHundredAndSeven | TwoHundredAndEight | TwoHundredAndSixteen | TwoHundredAndTwentyThree | TwoHundredAndTwentyNine | TwoHundredAndThirtyThree | TwoHundredAndThirtyFour | TwoHundredAndThirtyFive | TwoHundredAndThirtySix | TwoHundredAndThirtySeven | TwoHundredAndFortyTwo | TwoHundredAndFortySeven | TwoHundredAndFortyEight | TwoHundredAndSixtyThree | TwoHundredAndSixtyEight | Payload1 | Eleven | Twelve | Thirteen | Fourteen | Fifteen | Seventeen | Eighteen | TwentyThree | TwentySeven | ThirtyTwo | ThirtyThree | ThirtyFour | SeventyFour | SeventyFive | SeventySix | NinetyFour | NinetyFive | OneHundredAndForty | OneHundredAndSeventyOne | OneHundredAndSeventyEight | OneHundredAndSeventyNine | OneHundredAndEightyFive | OneHundredAndEightySix | OneHundredAndEightySeven | OneHundredAndNinetyFive | OneHundredAndNinetySix | OneHundredAndNinetySeven | TwoHundredAndFortyFour | TwoHundredAndSixtyFive | TwoHundredAndSixtySix;
/**
...
export type UserEvent = {
    ...
    payload?: TwoHundredAndFiftySeven | EightySeven | NinetyOne | NinetySix | NinetyEight | OneHundredAndThirtyFive | FiftySix | FiftySeven | SixtyNine | SeventyTwo | SeventyEight | EightyFive | EightyEight | EightyNine | OneHundredAndNine | TwoHundredAndNine | TwoHundredAndFiftyNine | TwoHundredAndSeventy | Payload2 | FiftyOne | SixtyOne | Ninety | NinetySeven | OneHundredAndTwentyFour | OneHundredAndTwentyNine | OneHundredAndThirty | OneHundredAndThirtyThree | OneHundredAndThirtySix | OneHundredAndFortyOne | OneHundredAndFortyTwo | OneHundredAndFortyThree | OneHundredAndFortyFour | OneHundredAndFortyFive | OneHundredAndFortySix | OneHundredAndFortySeven | OneHundredAndFortyEight | OneHundredAndFortyNine | OneHundredAndSixtySeven | OneHundredAndNinetyEight | OneHundredAndNinetyNine | TwoHundredAndTwentyOne | TwoHundredAndFortySix | TwoHundredAndFiftyEight | TwoHundredAndSixtyTwo | TwoHundredAndSixtySeven | Sixteen | Twenty | TwentyFour | TwentyEight | Forty | FortyOne | FortyTwo | FortyThree | FiftyFive | SixtyFour | SixtyFive | SixtySix | Seventy | SeventyNine | Eighty | EightyOne | EightyTwo | EightyFour | OneHundred | OneHundredAndFour | OneHundredAndSeven | OneHundredAndEight | OneHundredAndTen | OneHundredAndEleven | OneHundredAndTwelve | OneHundredAndThirteen | OneHundredAndFourteen | OneHundredAndFifteen | OneHundredAndTwenty | OneHundredAndTwentySix | OneHundredAndTwentyEight | OneHundredAndThirtyOne | OneHundredAndThirtyTwo | OneHundredAndThirtyFour | OneHundredAndThirtySeven | OneHundredAndThirtyEight | OneHundredAndThirtyNine | OneHundredAndFifty | OneHundredAndFiftyOne | OneHundredAndFiftyTwo | OneHundredAndFiftyThree | OneHundredAndFiftyFour | OneHundredAndFiftyEight | OneHundredAndSeventySix | TwoHundredAndEleven | TwoHundredAndTwelve | TwoHundredAndEighteen | TwoHundredAndNineteen | TwoHundredAndTwenty | TwoHundredAndTwentyTwo | TwoHundredAndTwentyFour | TwoHundredAndTwentySeven | TwoHundredAndThirtyEight | TwoHundredAndThirtyNine | TwoHundredAndForty | TwoHundredAndFortyNine | TwoHundredAndFifty | TwoHundredAndFiftyOne | TwoHundredAndFiftyTwo | TwoHundredAndFiftyThree | TwoHundredAndFiftySix | TwoHundredAndSixty | TwoHundredAndSixtyFour | TwoHundredAndSixtyNine | Three | Four | Six | Seven | Eight | TwentyOne | TwentyTwo | TwentyFive | Thirty | ThirtySix | ThirtyEight | FortyFive | FortySix | FortySeven | FortyEight | FortyNine | Fifty | FiftyTwo | FiftyNine | Sixty | SixtyThree | SeventyThree | SeventySeven | EightyThree | EightySix | OneHundredAndThree | OneHundredAndSixteen | OneHundredAndSeventeen | OneHundredAndEighteen | OneHundredAndNineteen | OneHundredAndTwentyOne | OneHundredAndTwentyTwo | OneHundredAndTwentyFive | OneHundredAndFiftyFive | OneHundredAndFiftySix | OneHundredAndFiftySeven | OneHundredAndFiftyNine | OneHundredAndSixty | OneHundredAndSixtyThree | OneHundredAndSixtyFour | OneHundredAndSixtyFive | OneHundredAndSeventyTwo | OneHundredAndSeventySeven | OneHundredAndEightyTwo | OneHundredAndEightyThree | OneHundredAndEightyEight | OneHundredAndEightyNine | OneHundredAndNinetyOne | OneHundredAndNinetyTwo | TwoHundredAndTwo | TwoHundredAndThree | TwoHundredAndFour | TwoHundredAndTen | TwoHundredAndThirteen | TwoHundredAndFourteen | TwoHundredAndFifteen | TwoHundredAndSeventeen | TwoHundredAndTwentyFive | TwoHundredAndTwentySix | TwoHundredAndTwentyEight | TwoHundredAndThirty | TwoHundredAndThirtyOne | TwoHundredAndThirtyTwo | TwoHundredAndFortyOne | TwoHundredAndFortyThree | TwoHundredAndFortyFive | TwoHundredAndFiftyFour | TwoHundredAndFiftyFive | TwoHundredAndSixtyOne | Five | Nine | Ten | Nineteen | TwentySix | TwentyNine | ThirtyOne | ThirtyFive | ThirtySeven | ThirtyNine | FortyFour | FiftyThree | FiftyFour | FiftyEight | SixtyTwo | SixtySeven | SixtyEight | SeventyOne | NinetyTwo | NinetyThree | NinetyNine | OneHundredAndOne | OneHundredAndTwo | OneHundredAndFive | OneHundredAndSix | OneHundredAndTwentyThree | OneHundredAndTwentySeven | OneHundredAndSixtyOne | OneHundredAndSixtyTwo | OneHundredAndSixtySix | OneHundredAndSixtyEight | OneHundredAndSixtyNine | OneHundredAndSeventy | OneHundredAndSeventyThree | OneHundredAndSeventyFour | OneHundredAndSeventyFive | OneHundredAndEighty | OneHundredAndEightyOne | OneHundredAndEightyFour | OneHundredAndNinety | OneHundredAndNinetyThree | OneHundredAndNinetyFour | TwoHundred | TwoHundredAndOne | TwoHundredAndFive | TwoHundredAndSix | TwoHundredAndSeven | TwoHundredAndEight | TwoHundredAndSixteen | TwoHundredAndTwentyThree | TwoHundredAndTwentyNine | TwoHundredAndThirtyThree | TwoHundredAndThirtyFour | TwoHundredAndThirtyFive | TwoHundredAndThirtySix | TwoHundredAndThirtySeven | TwoHundredAndFortyTwo | TwoHundredAndFortySeven | TwoHundredAndFortyEight | TwoHundredAndSixtyThree | TwoHundredAndSixtyEight | Payload1 | Eleven | Twelve | Thirteen | Fourteen | Fifteen | Seventeen | Eighteen | TwentyThree | TwentySeven | ThirtyTwo | ThirtyThree | ThirtyFour | SeventyFour | SeventyFive | SeventySix | NinetyFour | NinetyFive | OneHundredAndForty | OneHundredAndSeventyOne | OneHundredAndSeventyEight | OneHundredAndSeventyNine | OneHundredAndEightyFive | OneHundredAndEightySix | OneHundredAndEightySeven | OneHundredAndNinetyFive | OneHundredAndNinetySix | OneHundredAndNinetySeven | TwoHundredAndFortyFour | TwoHundredAndSixtyFive | TwoHundredAndSixtySix | undefined;
};
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2687HeadInfo$inboundSchema: z.ZodType<UserEventJobPayload2687HeadInfo, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2687HeadInfo$outboundSchema: z.ZodType<UserEventJobPayload2687HeadInfo$Outbound, z.ZodTypeDef, UserEventJobPayload2687HeadInfo>;
export declare function userEventJobPayload2687HeadInfoToJSON(userEventJobPayload2687HeadInfo: UserEventJobPayload2687HeadInfo): string;
export declare function userEventJobPayload2687HeadInfoFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload2687HeadInfo, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2687GitComments$inboundSchema: z.ZodType<UserEventJobPayload2687GitComments, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2687GitComments$outboundSchema: z.ZodType<UserEventJobPayload2687GitComments$Outbound, z.ZodTypeDef, UserEventJobPayload2687GitComments>;
export declare function userEventJobPayload2687GitCommentsToJSON(userEventJobPayload2687GitComments: UserEventJobPayload2687GitComments): string;
export declare function userEventJobPayload2687GitCommentsFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload2687GitComments, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload2687Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload2687Provider>;
/** @internal */
export declare const UserEventJobPayload2687Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload2687Provider>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2686GitComments$inboundSchema: z.ZodType<UserEventJobPayload2686GitComments, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2686GitComments$outboundSchema: z.ZodType<UserEventJobPayload2686GitComments$Outbound, z.ZodTypeDef, UserEventJobPayload2686GitComments>;
export declare function userEventJobPayload2686GitCommentsToJSON(userEventJobPayload2686GitComments: UserEventJobPayload2686GitComments): string;
export declare function userEventJobPayload2686GitCommentsFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload2686GitComments, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload268DeployHook$inboundSchema: z.ZodType<UserEventJobPayload268DeployHook, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload268DeployHook$outboundSchema: z.ZodType<UserEventJobPayload268DeployHook$Outbound, z.ZodTypeDef, UserEventJobPayload268DeployHook>;
export declare function userEventJobPayload268DeployHookToJSON(userEventJobPayload268DeployHook: UserEventJobPayload268DeployHook): string;
export declare function userEventJobPayload268DeployHookFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload268DeployHook, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload268Project$inboundSchema: z.ZodType<UserEventJobPayload268Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload268Project$outboundSchema: z.ZodType<UserEventJobPayload268Project$Outbound, z.ZodTypeDef, UserEventJobPayload268Project>;
export declare function userEventJobPayload268ProjectToJSON(userEventJobPayload268Project: UserEventJobPayload268Project): string;
export declare function userEventJobPayload268ProjectFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload268Project, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload2686HeadInfo$inboundSchema: z.ZodType<UserEventJobPayload2686HeadInfo, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2686HeadInfo$outboundSchema: z.ZodType<UserEventJobPayload2686HeadInfo$Outbound, z.ZodTypeDef, UserEventJobPayload2686HeadInfo>;
export declare function userEventJobPayload2686HeadInfoToJSON(userEventJobPayload2686HeadInfo: UserEventJobPayload2686HeadInfo): string;
export declare function userEventJobPayload2686HeadInfoFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload2686HeadInfo, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload2686Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload2686Provider>;
/** @internal */
export declare const UserEventJobPayload2686Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload2686Provider>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload268HeadInfo$inboundSchema: z.ZodType<UserEventJobPayload268HeadInfo, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload268HeadInfo$outboundSchema: z.ZodType<UserEventJobPayload268HeadInfo$Outbound, z.ZodTypeDef, UserEventJobPayload268HeadInfo>;
export declare function userEventJobPayload268HeadInfoToJSON(userEventJobPayload268HeadInfo: UserEventJobPayload268HeadInfo): string;
export declare function userEventJobPayload268HeadInfoFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload268HeadInfo, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload268GitComments$inboundSchema: z.ZodType<UserEventJobPayload268GitComments, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload268GitComments$outboundSchema: z.ZodType<UserEventJobPayload268GitComments$Outbound, z.ZodTypeDef, UserEventJobPayload268GitComments>;
export declare function userEventJobPayload268GitCommentsToJSON(userEventJobPayload268GitComments: UserEventJobPayload268GitComments): string;
export declare function userEventJobPayload268GitCommentsFromJSON(jsonString: string): SafeParseResult<UserEventJobPayload268GitComments, SDKValidationError>;
/** @internal */
export declare const UserEventJobPayload2685Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload2685Provider>;
/** @internal */
export declare const UserEventJobPayload2685Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload2685Provider>;
/** @internal */
...
/** @internal */
export declare const UserEventJobPayload268Provider$inboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload268Provider>;
/** @internal */
export declare const UserEventJobPayload268Provider$outboundSchema: z.ZodNativeEnum<typeof UserEventJobPayload268Provider>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload261Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload261Role>;
/** @internal */
export declare const UserEventPayload261Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload261Role>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload256ToAccountType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload256ToAccountType>;
/** @internal */
export declare const UserEventPayload256ToAccountType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload256ToAccountType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload249Previous$outboundSchema: z.ZodType<UserEventPayload249Previous$Outbound, z.ZodTypeDef, UserEventPayload249Previous>;
export declare function userEventPayload249PreviousToJSON(userEventPayload249Previous: UserEventPayload249Previous): string;
...
/** @internal */
export declare const UserEventPayload244Previous$inboundSchema: z.ZodType<UserEventPayload244Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload244Previous$Outbound = Previous1$Outbound | string;
/** @internal */
export declare const UserEventPayload244Previous$outboundSchema: z.ZodType<UserEventPayload244Previous$Outbound, z.ZodTypeDef, UserEventPayload244Previous>;
export declare function userEventPayload244PreviousToJSON(userEventPayload244Previous: UserEventPayload244Previous): string;
export declare function userEventPayload244PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload244Previous, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload244Next$inboundSchema: z.ZodType<UserEventPayload244Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload244Next$Outbound = Next1$Outbound | string;
/** @internal */
export declare const UserEventPayload244Next$outboundSchema: z.ZodType<UserEventPayload244Next$Outbound, z.ZodTypeDef, UserEventPayload244Next>;
export declare function userEventPayload244NextToJSON(userEventPayload244Next: UserEventPayload244Next): string;
export declare function userEventPayload244NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload244Next, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload240Team$inboundSchema: z.ZodType<UserEventPayload240Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload240Team$outboundSchema: z.ZodType<UserEventPayload240Team$Outbound, z.ZodTypeDef, UserEventPayload240Team>;
export declare function userEventPayload240TeamToJSON(userEventPayload240Team: UserEventPayload240Team): string;
export declare function userEventPayload240TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload240Team, SDKValidationError>;
/** @internal */
export declare const UserEventPayload240Configuration$inboundSchema: z.ZodType<UserEventPayload240Configuration, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload240Configuration$outboundSchema: z.ZodType<UserEventPayload240Configuration$Outbound, z.ZodTypeDef, UserEventPayload240Configuration>;
export declare function userEventPayload240ConfigurationToJSON(userEventPayload240Configuration: UserEventPayload240Configuration): string;
export declare function userEventPayload240ConfigurationFromJSON(jsonString: string): SafeParseResult<UserEventPayload240Configuration, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload239Team$inboundSchema: z.ZodType<UserEventPayload239Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload239Team$outboundSchema: z.ZodType<UserEventPayload239Team$Outbound, z.ZodTypeDef, UserEventPayload239Team>;
export declare function userEventPayload239TeamToJSON(userEventPayload239Team: UserEventPayload239Team): string;
export declare function userEventPayload239TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload239Team, SDKValidationError>;
/** @internal */
export declare const UserEventPayload239Configuration$inboundSchema: z.ZodType<UserEventPayload239Configuration, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload239Configuration$outboundSchema: z.ZodType<UserEventPayload239Configuration$Outbound, z.ZodTypeDef, UserEventPayload239Configuration>;
export declare function userEventPayload239ConfigurationToJSON(userEventPayload239Configuration: UserEventPayload239Configuration): string;
export declare function userEventPayload239ConfigurationFromJSON(jsonString: string): SafeParseResult<UserEventPayload239Configuration, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload238Team$inboundSchema: z.ZodType<UserEventPayload238Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload238Team$outboundSchema: z.ZodType<UserEventPayload238Team$Outbound, z.ZodTypeDef, UserEventPayload238Team>;
export declare function userEventPayload238TeamToJSON(userEventPayload238Team: UserEventPayload238Team): string;
export declare function userEventPayload238TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload238Team, SDKValidationError>;
/** @internal */
export declare const UserEventPayload238Configuration$inboundSchema: z.ZodType<UserEventPayload238Configuration, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload238Configuration$outboundSchema: z.ZodType<UserEventPayload238Configuration$Outbound, z.ZodTypeDef, UserEventPayload238Configuration>;
export declare function userEventPayload238ConfigurationToJSON(userEventPayload238Configuration: UserEventPayload238Configuration): string;
export declare function userEventPayload238ConfigurationFromJSON(jsonString: string): SafeParseResult<UserEventPayload238Configuration, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload236Type$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload236Type>;
/** @internal */
export declare const UserEventPayload236Type$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload236Type>;
/** @internal */
export declare const UserEventPayload236BeforeType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload236BeforeType>;
/** @internal */
export declare const UserEventPayload236BeforeType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload236BeforeType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload236AfterType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload236AfterType>;
/** @internal */
export declare const UserEventPayload236AfterType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload236AfterType>;
/** @internal */
export declare const UserEventPayload236AfterResourcesType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload236AfterResourcesType>;
/** @internal */
export declare const UserEventPayload236AfterResourcesType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload236AfterResourcesType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload236ProjectIds$inboundSchema: z.ZodType<UserEventPayload236ProjectIds, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload236ProjectIds$outboundSchema: z.ZodType<UserEventPayload236ProjectIds$Outbound, z.ZodTypeDef, UserEventPayload236ProjectIds>;
export declare function userEventPayload236ProjectIdsToJSON(userEventPayload236ProjectIds: UserEventPayload236ProjectIds): string;
export declare function userEventPayload236ProjectIdsFromJSON(jsonString: string): SafeParseResult<UserEventPayload236ProjectIds, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload236Permissions$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload236Permissions>;
/** @internal */
export declare const UserEventPayload236Permissions$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload236Permissions>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload235Type$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload235Type>;
/** @internal */
export declare const UserEventPayload235Type$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload235Type>;
/** @internal */
export declare const UserEventPayload235ResourcesType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload235ResourcesType>;
/** @internal */
export declare const UserEventPayload235ResourcesType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload235ResourcesType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload227Project$inboundSchema: z.ZodType<UserEventPayload227Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload227Project$outboundSchema: z.ZodType<UserEventPayload227Project$Outbound, z.ZodTypeDef, UserEventPayload227Project>;
export declare function userEventPayload227ProjectToJSON(userEventPayload227Project: UserEventPayload227Project): string;
export declare function userEventPayload227ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload227Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload227PrevProject$inboundSchema: z.ZodType<UserEventPayload227PrevProject, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload227PrevProject$outboundSchema: z.ZodType<UserEventPayload227PrevProject$Outbound, z.ZodTypeDef, UserEventPayload227PrevProject>;
export declare function userEventPayload227PrevProjectToJSON(userEventPayload227PrevProject: UserEventPayload227PrevProject): string;
export declare function userEventPayload227PrevProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload227PrevProject, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload226Project$inboundSchema: z.ZodType<UserEventPayload226Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload226Project$outboundSchema: z.ZodType<UserEventPayload226Project$Outbound, z.ZodTypeDef, UserEventPayload226Project>;
export declare function userEventPayload226ProjectToJSON(userEventPayload226Project: UserEventPayload226Project): string;
export declare function userEventPayload226ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload226Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload223Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload223Action>;
/** @internal */
export declare const UserEventPayload223Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload223Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload216Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload216Role>;
/** @internal */
export declare const UserEventPayload216Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload216Role>;
/** @internal */
export declare const UserEventPayload216Project$inboundSchema: z.ZodType<UserEventPayload216Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload216Project$outboundSchema: z.ZodType<UserEventPayload216Project$Outbound, z.ZodTypeDef, UserEventPayload216Project>;
export declare function userEventPayload216ProjectToJSON(userEventPayload216Project: UserEventPayload216Project): string;
export declare function userEventPayload216ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload216Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload215Project$inboundSchema: z.ZodType<UserEventPayload215Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload215Project$outboundSchema: z.ZodType<UserEventPayload215Project$Outbound, z.ZodTypeDef, UserEventPayload215Project>;
export declare function userEventPayload215ProjectToJSON(userEventPayload215Project: UserEventPayload215Project): string;
export declare function userEventPayload215ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload215Project, SDKValidationError>;
/** @internal */
export declare const UserEventPayload215Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload215Role>;
/** @internal */
export declare const UserEventPayload215Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload215Role>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload214Project$inboundSchema: z.ZodType<UserEventPayload214Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload214Project$outboundSchema: z.ZodType<UserEventPayload214Project$Outbound, z.ZodTypeDef, UserEventPayload214Project>;
export declare function userEventPayload214ProjectToJSON(userEventPayload214Project: UserEventPayload214Project): string;
export declare function userEventPayload214ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload214Project, SDKValidationError>;
/** @internal */
export declare const UserEventPayload214Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload214Role>;
/** @internal */
export declare const UserEventPayload214Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload214Role>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload213Project$inboundSchema: z.ZodType<UserEventPayload213Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload213Project$outboundSchema: z.ZodType<UserEventPayload213Project$Outbound, z.ZodTypeDef, UserEventPayload213Project>;
export declare function userEventPayload213ProjectToJSON(userEventPayload213Project: UserEventPayload213Project): string;
export declare function userEventPayload213ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload213Project, SDKValidationError>;
/** @internal */
export declare const UserEventPayload213Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload213Role>;
/** @internal */
export declare const UserEventPayload213Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload213Role>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload204Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload204Action>;
/** @internal */
export declare const UserEventPayload204Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload204Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload203Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload203Action>;
/** @internal */
export declare const UserEventPayload203Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload203Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload202Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload202Action>;
/** @internal */
export declare const UserEventPayload202Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload202Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload188Previous$inboundSchema: z.ZodType<UserEventPayload188Previous, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload188Previous$outboundSchema: z.ZodType<UserEventPayload188Previous$Outbound, z.ZodTypeDef, UserEventPayload188Previous>;
export declare function userEventPayload188PreviousToJSON(userEventPayload188Previous: UserEventPayload188Previous): string;
export declare function userEventPayload188PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload188Previous, SDKValidationError>;
/** @internal */
export declare const UserEventPayload188Next$inboundSchema: z.ZodType<UserEventPayload188Next, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload188Next$outboundSchema: z.ZodType<UserEventPayload188Next$Outbound, z.ZodTypeDef, UserEventPayload188Next>;
export declare function userEventPayload188NextToJSON(userEventPayload188Next: UserEventPayload188Next): string;
export declare function userEventPayload188NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload188Next, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload183User$inboundSchema: z.ZodType<UserEventPayload183User, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload183User$outboundSchema: z.ZodType<UserEventPayload183User$Outbound, z.ZodTypeDef, UserEventPayload183User>;
export declare function userEventPayload183UserToJSON(userEventPayload183User: UserEventPayload183User): string;
export declare function userEventPayload183UserFromJSON(jsonString: string): SafeParseResult<UserEventPayload183User, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload149Next$inboundSchema: z.ZodType<UserEventPayload149Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload149Next$Outbound = {
    skewProtectionAllowedDomains: Array<string>;
};
/** @internal */
export declare const UserEventPayload149Next$outboundSchema: z.ZodType<UserEventPayload149Next$Outbound, z.ZodTypeDef, UserEventPayload149Next>;
export declare function userEventPayload149NextToJSON(userEventPayload149Next: UserEventPayload149Next): string;
export declare function userEventPayload149NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload149Next, SDKValidationError>;
/** @internal */
export declare const UserEventPayload149Previous$inboundSchema: z.ZodType<UserEventPayload149Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload149Previous$Outbound = {
    skewProtectionAllowedDomains?: Array<string> | undefined;
};
/** @internal */
export declare const UserEventPayload149Previous$outboundSchema: z.ZodType<UserEventPayload149Previous$Outbound, z.ZodTypeDef, UserEventPayload149Previous>;
export declare function userEventPayload149PreviousToJSON(userEventPayload149Previous: UserEventPayload149Previous): string;
export declare function userEventPayload149PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload149Previous, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload148Next$inboundSchema: z.ZodType<UserEventPayload148Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload148Next$Outbound = {
    skewProtectionMaxAge: number;
};
/** @internal */
export declare const UserEventPayload148Next$outboundSchema: z.ZodType<UserEventPayload148Next$Outbound, z.ZodTypeDef, UserEventPayload148Next>;
export declare function userEventPayload148NextToJSON(userEventPayload148Next: UserEventPayload148Next): string;
export declare function userEventPayload148NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload148Next, SDKValidationError>;
/** @internal */
export declare const UserEventPayload148Previous$inboundSchema: z.ZodType<UserEventPayload148Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload148Previous$Outbound = {
    skewProtectionMaxAge?: number | undefined;
};
/** @internal */
export declare const UserEventPayload148Previous$outboundSchema: z.ZodType<UserEventPayload148Previous$Outbound, z.ZodTypeDef, UserEventPayload148Previous>;
export declare function userEventPayload148PreviousToJSON(userEventPayload148Previous: UserEventPayload148Previous): string;
export declare function userEventPayload148PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload148Previous, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload147Next$inboundSchema: z.ZodType<UserEventPayload147Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload147Next$Outbound = {
    skewProtectionBoundaryAt: number;
};
/** @internal */
export declare const UserEventPayload147Next$outboundSchema: z.ZodType<UserEventPayload147Next$Outbound, z.ZodTypeDef, UserEventPayload147Next>;
export declare function userEventPayload147NextToJSON(userEventPayload147Next: UserEventPayload147Next): string;
export declare function userEventPayload147NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload147Next, SDKValidationError>;
/** @internal */
export declare const UserEventPayload147Previous$inboundSchema: z.ZodType<UserEventPayload147Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload147Previous$Outbound = {
    skewProtectionBoundaryAt?: number | undefined;
};
/** @internal */
export declare const UserEventPayload147Previous$outboundSchema: z.ZodType<UserEventPayload147Previous$Outbound, z.ZodTypeDef, UserEventPayload147Previous>;
export declare function userEventPayload147PreviousToJSON(userEventPayload147Previous: UserEventPayload147Previous): string;
export declare function userEventPayload147PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload147Previous, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload146Previous$inboundSchema: z.ZodType<UserEventPayload146Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload146Previous$Outbound = {
    commandForIgnoringBuildStep?: string | undefined;
};
/** @internal */
export declare const UserEventPayload146Previous$outboundSchema: z.ZodType<UserEventPayload146Previous$Outbound, z.ZodTypeDef, UserEventPayload146Previous>;
export declare function userEventPayload146PreviousToJSON(userEventPayload146Previous: UserEventPayload146Previous): string;
export declare function userEventPayload146PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload146Previous, SDKValidationError>;
/** @internal */
export declare const UserEventPayload146Next$inboundSchema: z.ZodType<UserEventPayload146Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload146Next$Outbound = {
    commandForIgnoringBuildStep?: string | undefined;
};
/** @internal */
export declare const UserEventPayload146Next$outboundSchema: z.ZodType<UserEventPayload146Next$Outbound, z.ZodTypeDef, UserEventPayload146Next>;
export declare function userEventPayload146NextToJSON(userEventPayload146Next: UserEventPayload146Next): string;
export declare function userEventPayload146NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload146Next, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload145Previous$inboundSchema: z.ZodType<UserEventPayload145Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload145Previous$Outbound = {
    functionZeroConfigFailover: boolean | null;
};
/** @internal */
export declare const UserEventPayload145Previous$outboundSchema: z.ZodType<UserEventPayload145Previous$Outbound, z.ZodTypeDef, UserEventPayload145Previous>;
export declare function userEventPayload145PreviousToJSON(userEventPayload145Previous: UserEventPayload145Previous): string;
export declare function userEventPayload145PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload145Previous, SDKValidationError>;
/** @internal */
export declare const UserEventPayload145Next$inboundSchema: z.ZodType<UserEventPayload145Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload145Next$Outbound = {
    functionZeroConfigFailover: boolean;
};
/** @internal */
export declare const UserEventPayload145Next$outboundSchema: z.ZodType<UserEventPayload145Next$Outbound, z.ZodTypeDef, UserEventPayload145Next>;
export declare function userEventPayload145NextToJSON(userEventPayload145Next: UserEventPayload145Next): string;
export declare function userEventPayload145NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload145Next, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload144Previous$inboundSchema: z.ZodType<UserEventPayload144Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload144Previous$Outbound = {
    functionDefaultRegions: Array<string> | null;
};
/** @internal */
export declare const UserEventPayload144Previous$outboundSchema: z.ZodType<UserEventPayload144Previous$Outbound, z.ZodTypeDef, UserEventPayload144Previous>;
export declare function userEventPayload144PreviousToJSON(userEventPayload144Previous: UserEventPayload144Previous): string;
export declare function userEventPayload144PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload144Previous, SDKValidationError>;
/** @internal */
export declare const UserEventPayload144Next$inboundSchema: z.ZodType<UserEventPayload144Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload144Next$Outbound = {
    functionDefaultRegions: Array<string>;
};
/** @internal */
export declare const UserEventPayload144Next$outboundSchema: z.ZodType<UserEventPayload144Next$Outbound, z.ZodTypeDef, UserEventPayload144Next>;
export declare function userEventPayload144NextToJSON(userEventPayload144Next: UserEventPayload144Next): string;
export declare function userEventPayload144NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload144Next, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload143Previous$inboundSchema: z.ZodType<UserEventPayload143Previous, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload143Previous$Outbound = {
    functionDefaultMemoryType: string | null;
};
/** @internal */
export declare const UserEventPayload143Previous$outboundSchema: z.ZodType<UserEventPayload143Previous$Outbound, z.ZodTypeDef, UserEventPayload143Previous>;
export declare function userEventPayload143PreviousToJSON(userEventPayload143Previous: UserEventPayload143Previous): string;
export declare function userEventPayload143PreviousFromJSON(jsonString: string): SafeParseResult<UserEventPayload143Previous, SDKValidationError>;
/** @internal */
export declare const UserEventPayload143Next$inboundSchema: z.ZodType<UserEventPayload143Next, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload143Next$Outbound = {
    functionDefaultMemoryType: string;
};
/** @internal */
export declare const UserEventPayload143Next$outboundSchema: z.ZodType<UserEventPayload143Next$Outbound, z.ZodTypeDef, UserEventPayload143Next>;
export declare function userEventPayload143NextToJSON(userEventPayload143Next: UserEventPayload143Next): string;
export declare function userEventPayload143NextFromJSON(jsonString: string): SafeParseResult<UserEventPayload143Next, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload135Type$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload135Type>;
/** @internal */
export declare const UserEventPayload135Type$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload135Type>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload135NextType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload135NextType>;
/** @internal */
export declare const UserEventPayload135NextType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload135NextType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload130PreviousProject$inboundSchema: z.ZodType<UserEventPayload130PreviousProject, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload130PreviousProject$outboundSchema: z.ZodType<UserEventPayload130PreviousProject$Outbound, z.ZodTypeDef, UserEventPayload130PreviousProject>;
export declare function userEventPayload130PreviousProjectToJSON(userEventPayload130PreviousProject: UserEventPayload130PreviousProject): string;
export declare function userEventPayload130PreviousProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload130PreviousProject, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122Team$inboundSchema: z.ZodType<UserEventPayload122Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload122Team$outboundSchema: z.ZodType<UserEventPayload122Team$Outbound, z.ZodTypeDef, UserEventPayload122Team>;
export declare function userEventPayload122TeamToJSON(userEventPayload122Team: UserEventPayload122Team): string;
export declare function userEventPayload122TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload122Team, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload95Names$inboundSchema: z.ZodType<UserEventPayload95Names, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload95Names$Outbound = {
    en: string;
};
/** @internal */
export declare const UserEventPayload95Names$outboundSchema: z.ZodType<UserEventPayload95Names$Outbound, z.ZodTypeDef, UserEventPayload95Names>;
export declare function userEventPayload95NamesToJSON(userEventPayload95Names: UserEventPayload95Names): string;
export declare function userEventPayload95NamesFromJSON(jsonString: string): SafeParseResult<UserEventPayload95Names, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload95GeolocationNames$inboundSchema: z.ZodType<UserEventPayload95GeolocationNames, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload95GeolocationNames$Outbound = {
    en: string;
};
/** @internal */
export declare const UserEventPayload95GeolocationNames$outboundSchema: z.ZodType<UserEventPayload95GeolocationNames$Outbound, z.ZodTypeDef, UserEventPayload95GeolocationNames>;
export declare function userEventPayload95GeolocationNamesToJSON(userEventPayload95GeolocationNames: UserEventPayload95GeolocationNames): string;
export declare function userEventPayload95GeolocationNamesFromJSON(jsonString: string): SafeParseResult<UserEventPayload95GeolocationNames, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload95GeolocationMostSpecificSubdivisionNames$inboundSchema: z.ZodType<UserEventPayload95GeolocationMostSpecificSubdivisionNames, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload95GeolocationMostSpecificSubdivisionNames$Outbound = {
    en: string;
};
/** @internal */
export declare const UserEventPayload95GeolocationMostSpecificSubdivisionNames$outboundSchema: z.ZodType<UserEventPayload95GeolocationMostSpecificSubdivisionNames$Outbound, z.ZodTypeDef, UserEventPayload95GeolocationMostSpecificSubdivisionNames>;
export declare function userEventPayload95GeolocationMostSpecificSubdivisionNamesToJSON(userEventPayload95GeolocationMostSpecificSubdivisionNames: UserEventPayload95GeolocationMostSpecificSubdivisionNames): string;
export declare function userEventPayload95GeolocationMostSpecificSubdivisionNamesFromJSON(jsonString: string): SafeParseResult<UserEventPayload95GeolocationMostSpecificSubdivisionNames, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85Configuration$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85Configuration>;
/** @internal */
export declare const UserEventPayload85Configuration$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85Configuration>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85Role>;
/** @internal */
export declare const UserEventPayload85Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85Role>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85Type$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85Type>;
/** @internal */
export declare const UserEventPayload85Type$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85Type>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85BlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85BlockReason>;
/** @internal */
export declare const UserEventPayload85BlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85BlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksBlobBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksBlobBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksBlobBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksBlobBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksPostgresBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksPostgresBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksPostgresBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksPostgresBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksRedisBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksRedisBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksRedisBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksRedisBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksWorkflowStorageBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksWorkflowStepBlockReason>;
/** @internal */
export declare const UserEventPayload85NewOwnerFeatureBlocksWorkflowStepBlockReason$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerFeatureBlocksWorkflowStepBlockReason>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload85NewOwnerAction$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerAction>;
/** @internal */
export declare const UserEventPayload85NewOwnerAction$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload85NewOwnerAction>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload82Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload82Action>;
/** @internal */
export declare const UserEventPayload82Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload82Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload81Action$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload81Action>;
/** @internal */
export declare const UserEventPayload81Action$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload81Action>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload76OldEnvVarType$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload76OldEnvVarType>;
/** @internal */
export declare const UserEventPayload76OldEnvVarType$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload76OldEnvVarType>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload76Target$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload76Target>;
/** @internal */
export declare const UserEventPayload76Target$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload76Target>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload62OldTeam$inboundSchema: z.ZodType<UserEventPayload62OldTeam, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload62OldTeam$Outbound = {
    name: string;
};
/** @internal */
export declare const UserEventPayload62OldTeam$outboundSchema: z.ZodType<UserEventPayload62OldTeam$Outbound, z.ZodTypeDef, UserEventPayload62OldTeam>;
export declare function userEventPayload62OldTeamToJSON(userEventPayload62OldTeam: UserEventPayload62OldTeam): string;
export declare function userEventPayload62OldTeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload62OldTeam, SDKValidationError>;
/** @internal */
export declare const UserEventPayload62NewTeam$inboundSchema: z.ZodType<UserEventPayload62NewTeam, z.ZodTypeDef, unknown>;
/** @internal */
export type UserEventPayload62NewTeam$Outbound = {
    name: string;
};
/** @internal */
export declare const UserEventPayload62NewTeam$outboundSchema: z.ZodType<UserEventPayload62NewTeam$Outbound, z.ZodTypeDef, UserEventPayload62NewTeam>;
export declare function userEventPayload62NewTeamToJSON(userEventPayload62NewTeam: UserEventPayload62NewTeam): string;
export declare function userEventPayload62NewTeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload62NewTeam, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload43Team$inboundSchema: z.ZodType<UserEventPayload43Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload43Team$outboundSchema: z.ZodType<UserEventPayload43Team$Outbound, z.ZodTypeDef, UserEventPayload43Team>;
export declare function userEventPayload43TeamToJSON(userEventPayload43Team: UserEventPayload43Team): string;
export declare function userEventPayload43TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload43Team, SDKValidationError>;
/** @internal */
export declare const UserEventPayload43Configuration$inboundSchema: z.ZodType<UserEventPayload43Configuration, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload43Configuration$outboundSchema: z.ZodType<UserEventPayload43Configuration$Outbound, z.ZodTypeDef, UserEventPayload43Configuration>;
export declare function userEventPayload43ConfigurationToJSON(userEventPayload43Configuration: UserEventPayload43Configuration): string;
export declare function userEventPayload43ConfigurationFromJSON(jsonString: string): SafeParseResult<UserEventPayload43Configuration, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload42Configuration$inboundSchema: z.ZodType<UserEventPayload42Configuration, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload42Configuration$outboundSchema: z.ZodType<UserEventPayload42Configuration$Outbound, z.ZodTypeDef, UserEventPayload42Configuration>;
export declare function userEventPayload42ConfigurationToJSON(userEventPayload42Configuration: UserEventPayload42Configuration): string;
export declare function userEventPayload42ConfigurationFromJSON(jsonString: string): SafeParseResult<UserEventPayload42Configuration, SDKValidationError>;
/** @internal */
export declare const UserEventPayload42Project$inboundSchema: z.ZodType<UserEventPayload42Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload42Project$outboundSchema: z.ZodType<UserEventPayload42Project$Outbound, z.ZodTypeDef, UserEventPayload42Project>;
export declare function userEventPayload42ProjectToJSON(userEventPayload42Project: UserEventPayload42Project): string;
export declare function userEventPayload42ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload42Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload41Project$inboundSchema: z.ZodType<UserEventPayload41Project, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload41Project$outboundSchema: z.ZodType<UserEventPayload41Project$Outbound, z.ZodTypeDef, UserEventPayload41Project>;
export declare function userEventPayload41ProjectToJSON(userEventPayload41Project: UserEventPayload41Project): string;
export declare function userEventPayload41ProjectFromJSON(jsonString: string): SafeParseResult<UserEventPayload41Project, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload40Team$inboundSchema: z.ZodType<UserEventPayload40Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload40Team$outboundSchema: z.ZodType<UserEventPayload40Team$Outbound, z.ZodTypeDef, UserEventPayload40Team>;
export declare function userEventPayload40TeamToJSON(userEventPayload40Team: UserEventPayload40Team): string;
export declare function userEventPayload40TeamFromJSON(jsonString: string): SafeParseResult<UserEventPayload40Team, SDKValidationError>;
/** @internal */
...
/** @internal */
export type Payload$Outbound = TwoHundredAndFiftySeven$Outbound | EightySeven$Outbound | NinetyOne$Outbound | NinetySix$Outbound | NinetyEight$Outbound | OneHundredAndThirtyFive$Outbound | FiftySix$Outbound | FiftySeven$Outbound | SixtyNine$Outbound | SeventyTwo$Outbound | SeventyEight$Outbound | EightyFive$Outbound | EightyEight$Outbound | EightyNine$Outbound | OneHundredAndNine$Outbound | TwoHundredAndNine$Outbound | TwoHundredAndFiftyNine$Outbound | TwoHundredAndSeventy$Outbound | Payload2$Outbound | FiftyOne$Outbound | SixtyOne$Outbound | Ninety$Outbound | NinetySeven$Outbound | OneHundredAndTwentyFour$Outbound | OneHundredAndTwentyNine$Outbound | OneHundredAndThirty$Outbound | OneHundredAndThirtyThree$Outbound | OneHundredAndThirtySix$Outbound | OneHundredAndFortyOne$Outbound | OneHundredAndFortyTwo$Outbound | OneHundredAndFortyThree$Outbound | OneHundredAndFortyFour$Outbound | OneHundredAndFortyFive$Outbound | OneHundredAndFortySix$Outbound | OneHundredAndFortySeven$Outbound | OneHundredAndFortyEight$Outbound | OneHundredAndFortyNine$Outbound | OneHundredAndSixtySeven$Outbound | OneHundredAndNinetyEight$Outbound | OneHundredAndNinetyNine$Outbound | TwoHundredAndTwentyOne$Outbound | TwoHundredAndFortySix$Outbound | TwoHundredAndFiftyEight$Outbound | TwoHundredAndSixtyTwo$Outbound | TwoHundredAndSixtySeven$Outbound | Sixteen$Outbound | Twenty$Outbound | TwentyFour$Outbound | TwentyEight$Outbound | Forty$Outbound | FortyOne$Outbound | FortyTwo$Outbound | FortyThree$Outbound | FiftyFive$Outbound | SixtyFour$Outbound | SixtyFive$Outbound | SixtySix$Outbound | Seventy$Outbound | SeventyNine$Outbound | Eighty$Outbound | EightyOne$Outbound | EightyTwo$Outbound | EightyFour$Outbound | OneHundred$Outbound | OneHundredAndFour$Outbound | OneHundredAndSeven$Outbound | OneHundredAndEight$Outbound | OneHundredAndTen$Outbound | OneHundredAndEleven$Outbound | OneHundredAndTwelve$Outbound | OneHundredAndThirteen$Outbound | OneHundredAndFourteen$Outbound | OneHundredAndFifteen$Outbound | OneHundredAndTwenty$Outbound | OneHundredAndTwentySix$Outbound | OneHundredAndTwentyEight$Outbound | OneHundredAndThirtyOne$Outbound | OneHundredAndThirtyTwo$Outbound | OneHundredAndThirtyFour$Outbound | OneHundredAndThirtySeven$Outbound | OneHundredAndThirtyEight$Outbound | OneHundredAndThirtyNine$Outbound | OneHundredAndFifty$Outbound | OneHundredAndFiftyOne$Outbound | OneHundredAndFiftyTwo$Outbound | OneHundredAndFiftyThree$Outbound | OneHundredAndFiftyFour$Outbound | OneHundredAndFiftyEight$Outbound | OneHundredAndSeventySix$Outbound | TwoHundredAndEleven$Outbound | TwoHundredAndTwelve$Outbound | TwoHundredAndEighteen$Outbound | TwoHundredAndNineteen$Outbound | TwoHundredAndTwenty$Outbound | TwoHundredAndTwentyTwo$Outbound | TwoHundredAndTwentyFour$Outbound | TwoHundredAndTwentySeven$Outbound | TwoHundredAndThirtyEight$Outbound | TwoHundredAndThirtyNine$Outbound | TwoHundredAndForty$Outbound | TwoHundredAndFortyNine$Outbound | TwoHundredAndFifty$Outbound | TwoHundredAndFiftyOne$Outbound | TwoHundredAndFiftyTwo$Outbound | TwoHundredAndFiftyThree$Outbound | TwoHundredAndFiftySix$Outbound | TwoHundredAndSixty$Outbound | TwoHundredAndSixtyFour$Outbound | TwoHundredAndSixtyNine$Outbound | Three$Outbound | Four$Outbound | Six$Outbound | Seven$Outbound | Eight$Outbound | TwentyOne$Outbound | TwentyTwo$Outbound | TwentyFive$Outbound | Thirty$Outbound | ThirtySix$Outbound | ThirtyEight$Outbound | FortyFive$Outbound | FortySix$Outbound | FortySeven$Outbound | FortyEight$Outbound | FortyNine$Outbound | Fifty$Outbound | FiftyTwo$Outbound | FiftyNine$Outbound | Sixty$Outbound | SixtyThree$Outbound | SeventyThree$Outbound | SeventySeven$Outbound | EightyThree$Outbound | EightySix$Outbound | OneHundredAndThree$Outbound | OneHundredAndSixteen$Outbound | OneHundredAndSeventeen$Outbound | OneHundredAndEighteen$Outbound | OneHundredAndNineteen$Outbound | OneHundredAndTwentyOne$Outbound | OneHundredAndTwentyTwo$Outbound | OneHundredAndTwentyFive$Outbound | OneHundredAndFiftyFive$Outbound | OneHundredAndFiftySix$Outbound | OneHundredAndFiftySeven$Outbound | OneHundredAndFiftyNine$Outbound | OneHundredAndSixty$Outbound | OneHundredAndSixtyThree$Outbound | OneHundredAndSixtyFour$Outbound | OneHundredAndSixtyFive$Outbound | OneHundredAndSeventyTwo$Outbound | OneHundredAndSeventySeven$Outbound | OneHundredAndEightyTwo$Outbound | OneHundredAndEightyThree$Outbound | OneHundredAndEightyEight$Outbound | OneHundredAndEightyNine$Outbound | OneHundredAndNinetyOne$Outbound | OneHundredAndNinetyTwo$Outbound | TwoHundredAndTwo$Outbound | TwoHundredAndThree$Outbound | TwoHundredAndFour$Outbound | TwoHundredAndTen$Outbound | TwoHundredAndThirteen$Outbound | TwoHundredAndFourteen$Outbound | TwoHundredAndFifteen$Outbound | TwoHundredAndSeventeen$Outbound | TwoHundredAndTwentyFive$Outbound | TwoHundredAndTwentySix$Outbound | TwoHundredAndTwentyEight$Outbound | TwoHundredAndThirty$Outbound | TwoHundredAndThirtyOne$Outbound | TwoHundredAndThirtyTwo$Outbound | TwoHundredAndFortyOne$Outbound | TwoHundredAndFortyThree$Outbound | TwoHundredAndFortyFive$Outbound | TwoHundredAndFiftyFour$Outbound | TwoHundredAndFiftyFive$Outbound | TwoHundredAndSixtyOne$Outbound | Five$Outbound | Nine$Outbound | Ten$Outbound | Nineteen$Outbound | TwentySix$Outbound | TwentyNine$Outbound | ThirtyOne$Outbound | ThirtyFive$Outbound | ThirtySeven$Outbound | ThirtyNine$Outbound | FortyFour$Outbound | FiftyThree$Outbound | FiftyFour$Outbound | FiftyEight$Outbound | SixtyTwo$Outbound | SixtySeven$Outbound | SixtyEight$Outbound | SeventyOne$Outbound | NinetyTwo$Outbound | NinetyThree$Outbound | NinetyNine$Outbound | OneHundredAndOne$Outbound | OneHundredAndTwo$Outbound | OneHundredAndFive$Outbound | OneHundredAndSix$Outbound | OneHundredAndTwentyThree$Outbound | OneHundredAndTwentySeven$Outbound | OneHundredAndSixtyOne$Outbound | OneHundredAndSixtyTwo$Outbound | OneHundredAndSixtySix$Outbound | OneHundredAndSixtyEight$Outbound | OneHundredAndSixtyNine$Outbound | OneHundredAndSeventy$Outbound | OneHundredAndSeventyThree$Outbound | OneHundredAndSeventyFour$Outbound | OneHundredAndSeventyFive$Outbound | OneHundredAndEighty$Outbound | OneHundredAndEightyOne$Outbound | OneHundredAndEightyFour$Outbound | OneHundredAndNinety$Outbound | OneHundredAndNinetyThree$Outbound | OneHundredAndNinetyFour$Outbound | TwoHundred$Outbound | TwoHundredAndOne$Outbound | TwoHundredAndFive$Outbound | TwoHundredAndSix$Outbound | TwoHundredAndSeven$Outbound | TwoHundredAndEight$Outbound | TwoHundredAndSixteen$Outbound | TwoHundredAndTwentyThree$Outbound | TwoHundredAndTwentyNine$Outbound | TwoHundredAndThirtyThree$Outbound | TwoHundredAndThirtyFour$Outbound | TwoHundredAndThirtyFive$Outbound | TwoHundredAndThirtySix$Outbound | TwoHundredAndThirtySeven$Outbound | TwoHundredAndFortyTwo$Outbound | TwoHundredAndFortySeven$Outbound | TwoHundredAndFortyEight$Outbound | TwoHundredAndSixtyThree$Outbound | TwoHundredAndSixtyEight$Outbound | Payload1$Outbound | Eleven$Outbound | Twelve$Outbound | Thirteen$Outbound | Fourteen$Outbound | Fifteen$Outbound | Seventeen$Outbound | Eighteen$Outbound | TwentyThree$Outbound | TwentySeven$Outbound | ThirtyTwo$Outbound | ThirtyThree$Outbound | ThirtyFour$Outbound | SeventyFour$Outbound | SeventyFive$Outbound | SeventySix$Outbound | NinetyFour$Outbound | NinetyFive$Outbound | OneHundredAndForty$Outbound | OneHundredAndSeventyOne$Outbound | OneHundredAndSeventyEight$Outbound | OneHundredAndSeventyNine$Outbound | OneHundredAndEightyFive$Outbound | OneHundredAndEightySix$Outbound | OneHundredAndEightySeven$Outbound | OneHundredAndNinetyFive$Outbound | OneHundredAndNinetySix$Outbound | OneHundredAndNinetySeven$Outbound | TwoHundredAndFortyFour$Outbound | TwoHundredAndSixtyFive$Outbound | TwoHundredAndSixtySix$Outbound;
/** @internal */
...
export type UserEvent$Outbound = {
    ...
    principalId: string;
    viaIds?: Array<string> | undefined;
    payload?: TwoHundredAndFiftySeven$Outbound | EightySeven$Outbound | NinetyOne$Outbound | NinetySix$Outbound | NinetyEight$Outbound | OneHundredAndThirtyFive$Outbound | FiftySix$Outbound | FiftySeven$Outbound | SixtyNine$Outbound | SeventyTwo$Outbound | SeventyEight$Outbound | EightyFive$Outbound | EightyEight$Outbound | EightyNine$Outbound | OneHundredAndNine$Outbound | TwoHundredAndNine$Outbound | TwoHundredAndFiftyNine$Outbound | TwoHundredAndSeventy$Outbound | Payload2$Outbound | FiftyOne$Outbound | SixtyOne$Outbound | Ninety$Outbound | NinetySeven$Outbound | OneHundredAndTwentyFour$Outbound | OneHundredAndTwentyNine$Outbound | OneHundredAndThirty$Outbound | OneHundredAndThirtyThree$Outbound | OneHundredAndThirtySix$Outbound | OneHundredAndFortyOne$Outbound | OneHundredAndFortyTwo$Outbound | OneHundredAndFortyThree$Outbound | OneHundredAndFortyFour$Outbound | OneHundredAndFortyFive$Outbound | OneHundredAndFortySix$Outbound | OneHundredAndFortySeven$Outbound | OneHundredAndFortyEight$Outbound | OneHundredAndFortyNine$Outbound | OneHundredAndSixtySeven$Outbound | OneHundredAndNinetyEight$Outbound | OneHundredAndNinetyNine$Outbound | TwoHundredAndTwentyOne$Outbound | TwoHundredAndFortySix$Outbound | TwoHundredAndFiftyEight$Outbound | TwoHundredAndSixtyTwo$Outbound | TwoHundredAndSixtySeven$Outbound | Sixteen$Outbound | Twenty$Outbound | TwentyFour$Outbound | TwentyEight$Outbound | Forty$Outbound | FortyOne$Outbound | FortyTwo$Outbound | FortyThree$Outbound | FiftyFive$Outbound | SixtyFour$Outbound | SixtyFive$Outbound | SixtySix$Outbound | Seventy$Outbound | SeventyNine$Outbound | Eighty$Outbound | EightyOne$Outbound | EightyTwo$Outbound | EightyFour$Outbound | OneHundred$Outbound | OneHundredAndFour$Outbound | OneHundredAndSeven$Outbound | OneHundredAndEight$Outbound | OneHundredAndTen$Outbound | OneHundredAndEleven$Outbound | OneHundredAndTwelve$Outbound | OneHundredAndThirteen$Outbound | OneHundredAndFourteen$Outbound | OneHundredAndFifteen$Outbound | OneHundredAndTwenty$Outbound | OneHundredAndTwentySix$Outbound | OneHundredAndTwentyEight$Outbound | OneHundredAndThirtyOne$Outbound | OneHundredAndThirtyTwo$Outbound | OneHundredAndThirtyFour$Outbound | OneHundredAndThirtySeven$Outbound | OneHundredAndThirtyEight$Outbound | OneHundredAndThirtyNine$Outbound | OneHundredAndFifty$Outbound | OneHundredAndFiftyOne$Outbound | OneHundredAndFiftyTwo$Outbound | OneHundredAndFiftyThree$Outbound | OneHundredAndFiftyFour$Outbound | OneHundredAndFiftyEight$Outbound | OneHundredAndSeventySix$Outbound | TwoHundredAndEleven$Outbound | TwoHundredAndTwelve$Outbound | TwoHundredAndEighteen$Outbound | TwoHundredAndNineteen$Outbound | TwoHundredAndTwenty$Outbound | TwoHundredAndTwentyTwo$Outbound | TwoHundredAndTwentyFour$Outbound | TwoHundredAndTwentySeven$Outbound | TwoHundredAndThirtyEight$Outbound | TwoHundredAndThirtyNine$Outbound | TwoHundredAndForty$Outbound | TwoHundredAndFortyNine$Outbound | TwoHundredAndFifty$Outbound | TwoHundredAndFiftyOne$Outbound | TwoHundredAndFiftyTwo$Outbound | TwoHundredAndFiftyThree$Outbound | TwoHundredAndFiftySix$Outbound | TwoHundredAndSixty$Outbound | TwoHundredAndSixtyFour$Outbound | TwoHundredAndSixtyNine$Outbound | Three$Outbound | Four$Outbound | Six$Outbound | Seven$Outbound | Eight$Outbound | TwentyOne$Outbound | TwentyTwo$Outbound | TwentyFive$Outbound | Thirty$Outbound | ThirtySix$Outbound | ThirtyEight$Outbound | FortyFive$Outbound | FortySix$Outbound | FortySeven$Outbound | FortyEight$Outbound | FortyNine$Outbound | Fifty$Outbound | FiftyTwo$Outbound | FiftyNine$Outbound | Sixty$Outbound | SixtyThree$Outbound | SeventyThree$Outbound | SeventySeven$Outbound | EightyThree$Outbound | EightySix$Outbound | OneHundredAndThree$Outbound | OneHundredAndSixteen$Outbound | OneHundredAndSeventeen$Outbound | OneHundredAndEighteen$Outbound | OneHundredAndNineteen$Outbound | OneHundredAndTwentyOne$Outbound | OneHundredAndTwentyTwo$Outbound | OneHundredAndTwentyFive$Outbound | OneHundredAndFiftyFive$Outbound | OneHundredAndFiftySix$Outbound | OneHundredAndFiftySeven$Outbound | OneHundredAndFiftyNine$Outbound | OneHundredAndSixty$Outbound | OneHundredAndSixtyThree$Outbound | OneHundredAndSixtyFour$Outbound | OneHundredAndSixtyFive$Outbound | OneHundredAndSeventyTwo$Outbound | OneHundredAndSeventySeven$Outbound | OneHundredAndEightyTwo$Outbound | OneHundredAndEightyThree$Outbound | OneHundredAndEightyEight$Outbound | OneHundredAndEightyNine$Outbound | OneHundredAndNinetyOne$Outbound | OneHundredAndNinetyTwo$Outbound | TwoHundredAndTwo$Outbound | TwoHundredAndThree$Outbound | TwoHundredAndFour$Outbound | TwoHundredAndTen$Outbound | TwoHundredAndThirteen$Outbound | TwoHundredAndFourteen$Outbound | TwoHundredAndFifteen$Outbound | TwoHundredAndSeventeen$Outbound | TwoHundredAndTwentyFive$Outbound | TwoHundredAndTwentySix$Outbound | TwoHundredAndTwentyEight$Outbound | TwoHundredAndThirty$Outbound | TwoHundredAndThirtyOne$Outbound | TwoHundredAndThirtyTwo$Outbound | TwoHundredAndFortyOne$Outbound | TwoHundredAndFortyThree$Outbound | TwoHundredAndFortyFive$Outbound | TwoHundredAndFiftyFour$Outbound | TwoHundredAndFiftyFive$Outbound | TwoHundredAndSixtyOne$Outbound | Five$Outbound | Nine$Outbound | Ten$Outbound | Nineteen$Outbound | TwentySix$Outbound | TwentyNine$Outbound | ThirtyOne$Outbound | ThirtyFive$Outbound | ThirtySeven$Outbound | ThirtyNine$Outbound | FortyFour$Outbound | FiftyThree$Outbound | FiftyFour$Outbound | FiftyEight$Outbound | SixtyTwo$Outbound | SixtySeven$Outbound | SixtyEight$Outbound | SeventyOne$Outbound | NinetyTwo$Outbound | NinetyThree$Outbound | NinetyNine$Outbound | OneHundredAndOne$Outbound | OneHundredAndTwo$Outbound | OneHundredAndFive$Outbound | OneHundredAndSix$Outbound | OneHundredAndTwentyThree$Outbound | OneHundredAndTwentySeven$Outbound | OneHundredAndSixtyOne$Outbound | OneHundredAndSixtyTwo$Outbound | OneHundredAndSixtySix$Outbound | OneHundredAndSixtyEight$Outbound | OneHundredAndSixtyNine$Outbound | OneHundredAndSeventy$Outbound | OneHundredAndSeventyThree$Outbound | OneHundredAndSeventyFour$Outbound | OneHundredAndSeventyFive$Outbound | OneHundredAndEighty$Outbound | OneHundredAndEightyOne$Outbound | OneHundredAndEightyFour$Outbound | OneHundredAndNinety$Outbound | OneHundredAndNinetyThree$Outbound | OneHundredAndNinetyFour$Outbound | TwoHundred$Outbound | TwoHundredAndOne$Outbound | TwoHundredAndFive$Outbound | TwoHundredAndSix$Outbound | TwoHundredAndSeven$Outbound | TwoHundredAndEight$Outbound | TwoHundredAndSixteen$Outbound | TwoHundredAndTwentyThree$Outbound | TwoHundredAndTwentyNine$Outbound | TwoHundredAndThirtyThree$Outbound | TwoHundredAndThirtyFour$Outbound | TwoHundredAndThirtyFive$Outbound | TwoHundredAndThirtySix$Outbound | TwoHundredAndThirtySeven$Outbound | TwoHundredAndFortyTwo$Outbound | TwoHundredAndFortySeven$Outbound | TwoHundredAndFortyEight$Outbound | TwoHundredAndSixtyThree$Outbound | TwoHundredAndSixtyEight$Outbound | Payload1$Outbound | Eleven$Outbound | Twelve$Outbound | Thirteen$Outbound | Fourteen$Outbound | Fifteen$Outbound | Seventeen$Outbound | Eighteen$Outbound | TwentyThree$Outbound | TwentySeven$Outbound | ThirtyTwo$Outbound | ThirtyThree$Outbound | ThirtyFour$Outbound | SeventyFour$Outbound | SeventyFive$Outbound | SeventySix$Outbound | NinetyFour$Outbound | NinetyFive$Outbound | OneHundredAndForty$Outbound | OneHundredAndSeventyOne$Outbound | OneHundredAndSeventyEight$Outbound | OneHundredAndSeventyNine$Outbound | OneHundredAndEightyFive$Outbound | OneHundredAndEightySix$Outbound | OneHundredAndEightySeven$Outbound | OneHundredAndNinetyFive$Outbound | OneHundredAndNinetySix$Outbound | OneHundredAndNinetySeven$Outbound | TwoHundredAndFortyFour$Outbound | TwoHundredAndSixtyFive$Outbound | TwoHundredAndSixtySix$Outbound | undefined;
};
/** @internal */
