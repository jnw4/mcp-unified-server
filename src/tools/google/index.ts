...
const getWriteAuth = (scopes: string[]): JWT => {
...
const sharePublicly = async (drive: ReturnType<typeof google.drive>, fileId: string): Promise<void> => {
...
// Tool handler
export async function handleGoogleTool(name: string, args: any): Promise<any> {
  try {
    switch (name) {
