...
// Get Ramp client
function getRampClient(): AxiosInstance {
...
// Tool handler
export async function handleRampTool(name: string, args: any): Promise<any> {
  try {
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              success: true,
              total_count: response.data.page?.total || response.data.data?.length || 0,
              cards: response.data.data?.map((card: any) => ({
                id: card.id,
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              success: true,
              total_count: response.data.page?.total || response.data.data?.length || 0,
              departments: response.data.data?.map((dept: any) => ({
                id: dept.id,
                name: dept.name,
                code: dept.code,
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              success: true,
              total_count: response.data.page?.total || response.data.data?.length || 0,
              vendors: response.data.data?.map((vendor: any) => ({
                id: vendor.id,
                name: vendor.name,
