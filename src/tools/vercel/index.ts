...
// Tool handler
export async function handleVercelTool(name: string, args: any): Promise<any> {
  try {
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              ...
              deployments: response.data.deployments?.map((deployment: any) => ({
                uid: deployment.uid,
                url: deployment.url,
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              success: true,
              project_id,
              envs: response.data.envs?.map((env: any) => ({
                id: env.id,
                key: env.key,
